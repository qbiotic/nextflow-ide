...
3. Phase 1 - Workspace Detection & Activation (depends on 2): implement robust Nextflow project detection and extension activation strategy for multi-root workspaces on top of the existing Nx scaffold.
